            ...
            switch (i) {
                ...
                case 4:
                    this.storage.get(__WEBPACK_IMPORTED_MODULE_4__services_constants__["a" /* Constants */].storageKeyBubble4).then(function (val) {
                        ...
                        var currentTime = _this.displayRunningTime;
                        setInterval(function () {
                            _this.displayRunningTime = _this.decreaseSecond(currentTime);
                            currentTime = _this.displayRunningTime;
                        }, 1000);
                    });
                    break;
            }
    ...
    WifiPage.prototype.showIPButton = function () {
        ...
        myMatTest.then(function (response) {
            ...
            if (_this.verifyValues(response)) {
                ...
                _this.current_status = 'fail ' + _this.intervalCount;
            }
            _this.current_status = 'fail 0';
        }, function (response) {
            _this.failStatusVerification();
            _this.current_status = 'fail ' + _this.intervalCount;
        });
