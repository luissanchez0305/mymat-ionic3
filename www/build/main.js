...
var WifiPage = (function () {
    ...
    WifiPage.prototype.verifyValues = function (response) {
        if (response.indexOf("<p><h4>Power: ") > -1) {
            ...
            this.powerVal = power[0].substr(0, power[0].length - 1);
            if (this.powerVal > 75)
                this.batteryImg = 'assets/img/b100.png';
            else if (this.powerVal > 50)
                this.batteryImg = 'assets/img/b75.png';
            else if (this.powerVal > 25)
                this.batteryImg = 'assets/img/b50.png';
            else if (this.powerVal > 10)
...
var PlayingPage = (function () {
    function PlayingPage(navCtrl, navParams, storage, translateService, /*private localNotifications: LocalNotifications,*/ plt, zone, apiService, device, network) {
        ...
        this.storage.get(__WEBPACK_IMPORTED_MODULE_4__services_constants__["a" /* Constants */].deviceInfoKey).then(function (info) {
            _this.uuid = info.uuid;
            console.debug('Obteniendo uuid desde storage: ', _this.uuid);
        });
    }
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, translateService, menuCtrl, storage, events, oneSignal, ringtones, /*private backgroundMode: BackgroundMode,*/ device) {
        ...
        this.signal_app_id_ANDROID = 'd3aad1d0-7a05-4639-8467-40c8d41f84b6';
        this.signal_app_id_IOS = 'ad0ffa67-dd23-4ea1-8f4f-77b553537e5a';
    ...
    MyApp.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (uuid != '') {
                _this.settingOneSignal(uuid);
            }
        });
    };
    MyApp.prototype.sonarRington = function () {
    ...
    MyApp.prototype.settingOneSignal = function (prmuuid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var idApp;
